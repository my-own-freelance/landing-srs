...
@section('content')
    <div
        ...
        <h1 class="title fw-bold text-white mb-3">PT. SAMUDERA RIZKI SEJAHTERA</h1>
        <p class="subtitle text-white op-7">Pelayanan Export Hasil Laut dan Rempah Rempah Indonesia</p>
    </div>
